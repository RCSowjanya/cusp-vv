...
const KeyObjects = () => {
    const data = [
        {
          ...
          description:"Promoting sustainable energy practices that benefit the environment.",
          img: abouticon1,
        },
        {
        ...
        },
        {
          ...
          description:
            "Ensuring growth and success for our service partners.",
          img: abouticon2,
        },
    ...
    <div className='bg-[#FFF4D9] px-[4%] py-[4%] '>
        <div className='text-center'>
            <h4 className='text-[#196625] inter font-[700] text-[24px]'>Key Objectives</h4>
          <h2 className='text-[34px] font-[600] ad max-[600px]:text-[30px]'>Driving Sustainability, Empowering Customers, Supporting Providers</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-11">
        {data.map((item, index) => (
          <div key={index} className="bg-[#54E4A6] p-6 rounded-lg shadow-md flex flex-col items-center">
